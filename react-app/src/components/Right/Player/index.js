        ...
        <div className='navbar-player'>
            ...
            <div className='player-lcd'>
                <div className='player-lcd-artwork'>
                    <img src='https://goldeneragrooves.s3.us-east-2.amazonaws.com/2.png' alt='icon' style={{boxShadow: "0 1px 1px rgb(0 0 0 / 1%), 0 2px 2px rgb(0 0 0 / 1%), 0 4px 4px rgb(0 0 0 / 2%), 0 8px 8px rgb(0 0 0 / 3%), 0 14px 14px rgb(0 0 0 / 3%)"}}/>
                </div>
                {
                    !song &&
