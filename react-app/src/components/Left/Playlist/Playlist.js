    ...
    return (
        <>
            <div className='playlist-header'>
                <img src='https://github.com/vietha3110/melodify/blob/main/react-app/src/components/AppLeft/Playlist/playlist-icon.png?raw=true' className='playlist-icon' alt='icon'/>
